...
public class TimeBenchmark_SingleCore {
	...
	private static void TimeBenchmarkIterate(int iteraciones, int rango) throws BenchmarkException {
		...
		for (int i = 0; i <= 10; i++) {
			...
			System.out.println(auxIteraciones + " iterations finished in " + tiempoReguladoIteracion + " "
		...
		System.out.println("Total time spent on " + iteraciones + " iterations was: " + tiempoReguladoTotal + " "
				+ unidad + "(" + (tiempoTotalNano) + "ns" + ")");
